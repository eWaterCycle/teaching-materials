...
#         recalculating_label.value = "Loading...."
...
#         recalculating_label.value = "Recalculation Complete"
...
#     ui = VBox([counter_display, recalculating_label] + slider_widgets) #+ list(sliders.values()))
...
def interactive_plot(model, forcing, params):
    ...
    # Create a display widget to show the counter
    counter_display = HTML(value=f"<b>{param_change_counter} times recalculated </b>")
    ...
    def on_button_click(b=None):
        global param_change_counter
        param_change_counter += 1
        counter_display.value = f"<b>{param_change_counter} times recalculated </b>"
